(() => {
  ...
  ready(() => {
    ...
    // Evita links vazios e âncoras que fazem a página “pular” sem necessidade.
    document.querySelectorAll('a[href="#"]').forEach(a=>a.addEventListener('click',e=>e.preventDefault()));

    // Abre o WhatsApp com uma mensagem inicial quando o link estiver configurado.
    ...
    // Se houver formulário de interesse, impede envio quebrado e oferece WhatsApp.
