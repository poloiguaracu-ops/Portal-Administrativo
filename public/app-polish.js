(() => {
  ...
  ready(() => {
    ...
    if (isInstituto) {
      const s=document.createElement('script'); s.src=asset('instituto-pro.js?v=2'); s.defer=true; document.body.appendChild(s);
